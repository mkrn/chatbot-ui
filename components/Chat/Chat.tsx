          ...
          <div className="mx-auto flex h-full w-[300px] flex-col justify-center space-y-6 sm:w-[600px]">
            ...
            <div className="text-center text-lg text-black dark:text-white">
              ...
              <div className="mb-2 font-bold">
                Important: WiseBuddy is 100% unaffiliated with OpenAI.
              </div>
            </div>
            <div className="text-center text-gray-500 dark:text-gray-400">
              <div className="mb-2">
                WiseBuddy allows you to plug in your API key to use this UI with
                their API.
              </div>
              <div className="mb-2">
              ...
              {conversation.messages.length === 0 ? (
                <>
                  <div className="mx-auto flex w-[350px] flex-col space-y-10 pt-12 sm:w-[600px]">
                    ...
                    {models.length > 0 && (
                      <div className="flex h-full flex-col space-y-4 rounded-lg border border-neutral-200 p-4 text-black dark:border-neutral-600 dark:text-white">
                        {/* <ModelSelect
